            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/verifikator/edit/<?php echo $induk->id_lop; ?>">
                            <div class="row clearfix">
                                <div class="col-sm-6">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="form-group">
                                    <h2 class="card-inside-title">No Durk Vestyna</h2>                                    
                                        <div class="form-line">
                                            <input type="text" value="<?php echo $induk->no_vestyna;?>" id="no_vestyna" class="form-control" placeholder="NO DURK VESTYNA.." name="no_vestyna"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="form-group">
                                    <h2 class="card-inside-title">No PO</h2>                                    
                                        <div class="form-line">
                                            <input type="text" value="<?php echo $induk->no_po;?>" id="no_po" class="form-control" placeholder="NO PO.." name="no_po"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                ...
                                <div class="form-group">
                                    <h2 class="card-inside-title">Bulan BAST</h2>                                    
                                        <div class="form-line">
                                            <input type="text" value="<?php echo $induk->bulan_bast;?>" id="bulan_bast" class="form-control" placeholder="BULAN BAST.." name="bulan_bast"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                ...
                                <div class="form-group">
                                    <h2 class="card-inside-title">No INV</h2>                                    
                                        <div class="form-line">
                                            <input type="text" value="<?php echo $induk->no_inv;?>" id="no_inv" class="form-control" placeholder="NO INV.." name="no_inv"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
