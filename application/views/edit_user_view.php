            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/admin/edit/<?php echo $user->nik; ?>">
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                    <h2 class="card-inside-title">NIK</h2>                                    
                                        <div class="form-line">
                                            <input type="text" value="<?php echo $user->nik; ?>" class="form-control" placeholder="NIK.." name="nik"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <h2 class="card-inside-title">NAMA</h2>                                    
                                        <div class="form-line">
                                            <input type="text" value="<?php echo $user->nama; ?>" class="form-control" placeholder="NAMA.." name="nama"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
